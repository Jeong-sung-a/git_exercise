...
# 변수 설정
base_dir = './faces/'   # 사진을 저장할 디렉터리 경로
target_cnt = 400        # 수집할 사진 개수
cnt = 0                 # 사진 촬영 수

# 얼굴 검출 분류기 생성
face_classifier = cv2.CascadeClassifier('../MachineLearning/Resource/haarcascade_frontalface_default.xml')

# 사용자 이름과 번호를 입력받아 디렉터리 생성
