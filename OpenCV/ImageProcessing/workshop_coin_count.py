...
# 이미지 위치
img = cv2.imread('../ImageProcessing/Resource/coins.jpg')
...
# 거리 변환 결과 값의 절반 이상을 차지한 영역을 확실한 전경으로 설정
...
for i, label in enumerate(coin_label):
    ...
    cv2.imwrite('../ImageProcessing/coin_test/coin%d.jpg' %(i + 1), coin)
cv2.waitKey()
